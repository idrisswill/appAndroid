    ...
    publications {
        create<MavenPublication>("release") {
            ...
            pom {
                ...
                url.set("https://github.com/idrisswill/appandroid/")
                ...
                scm {
                    connection.set("scm:git:git://github.com/idrisswill/appandroid.git")
                    developerConnection.set("scm:git:ssh://github.com/idrisswill/appandroid.git")
                    url.set("https://github.com/idrisswill/appandroid/")
                }
                issueManagement {
                    system.set("GitHub Issues")
                    url.set("https://github.com/idrisswill/appandroid/issues")
                }
            }
        }
    }
